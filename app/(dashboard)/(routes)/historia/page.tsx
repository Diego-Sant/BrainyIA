...
const HistoryPage = () => {
    ...
    const onSubmit = async(values: z.infer<typeof formSchema>) => {
        try {
            ...
            const response = await axios.post("/api/historia", {
  ...
  return (
    <div>
        <div className="flex justify-between items-center">
            <Heading title="História" description="Tire dúvidas sobre acontecimentos históricos, curiosidades e muito mais!" icon={ScrollText} iconColor="text-yellow-600" bgColor="bg-yellow-600/10" />
            <AlertDialog>
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={clearHistoryMessage}>Deletar</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
        </div>
                        ...
                        <FormField name="prompt" render={({ field }) => (
                            <FormItem className="col-span-10 lg:col-span-11">
                                <FormControl className="m-0 p-0">
                                    <textarea className="text-sm bg-[#1f1f1f] pt-[0.1rem] lg:pt-[0.6rem] -mb-4 focus-visible:ring-0 focus-visible:ring-transparent w-full outline-none" disabled={isLoading} placeholder="Ex: Qual foi a civilização que construiu a Grande Pirâmide de Gizé?" {...field} />
                                </FormControl>
                            </FormItem>
                        )} />
